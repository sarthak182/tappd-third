            ...
            <div className="tappd-features">
              <div className="tappd-features-upper-section">
                <div className="tappd-features-upper-section-first-cont">
                  <img src="/images/UpperSectionLeftFeature.png" alt="first-icon" className="upper-section-left-image"/>
                ...
                <div className="tappd-features-upper-section-second-cont">
                  <img src="/images/UpperSectionRightFeature.png" alt="second-icon" className="upper-section-right-image"/>
              ...
              <div className="tappd-features-lower-section">
                <div className="tappd-features-lower-section-first-cont">
                  <img src="/images/LowerSectionLeftFeature.png" alt="third-icon" className="lower-section-left-image"/>
                ...
                <div className="tappd-features-lower-section-second-cont">
                  <img src="/images/LowerSectionRightFeature.png" alt="fourth-icon" className="lower-section-right-image"/>
